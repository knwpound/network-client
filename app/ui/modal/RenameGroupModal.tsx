    ...
    return(
      ...
      >
        ...
        <div className="modal-body mb-3 text-center align-items-center justify-content-center">
            <input type="text" className="form-control px-3 py-1 rounded-2 text-center fw-medium" placeholder="New Group Name"/>
            <div className="d-flex mt-4 align-items-center justify-content-center">
                <button className="btn fw-bold me-5 py-2 px-4 " style={{backgroundColor:"lightgray"}}>Cancel</button>
                <button className="btn fw-bold py-2 px-4 " style={{backgroundColor:"#FFCEB4"}}>Rename</button>
            </div>
        </div>
      </div>
    </div>
